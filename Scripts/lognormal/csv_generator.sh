...
then
	...
	then 
		...
		do
	  		scavetool scalar -p "name(\"X\") OR name(\"mk\") OR name(\"mt\") OR name(\"switchTime\") OR name(\"wk\") OR name(\"wt\") OR name(\"queueLength:max\")" -O $f.csv -F csv $f
		done	
		...
		for f in ${path_dir}/*.sca
		do
	  		scavetool scalar -p "name(\"X\") OR name(\"mk\") OR name(\"mt\") OR name(\"switchTime\") OR name(\"wk\") OR name(\"wt\") OR name(\"numSwitch:sum\")" -O $f.csv -F csv $f
		done	
		...
		for f in ${path_dir}/*.sca
		do
			scavetool scalar -p "name(\"X\") OR name(\"mk\") OR name(\"mt\") OR name(\"switchTime\") OR name(\"wk\") OR name(\"wt\") OR name(\"responseTime:mean\")" -O $f.csv -F csv $f
		done
		...
		for f in ${path_dir}/*.sca
		do
			scavetool scalar -p "name(\"X\") OR name(\"mk\") OR name(\"mt\") OR name(\"switchTime\") OR name(\"wk\") OR name(\"wt\") OR name(\"packetReceived:sum\")" -O $f.csv -F csv $f
		done
