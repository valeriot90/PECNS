...
for i in range(number_of_repetitions):
	...
	#moving_avg_y_values[i,N-1:-N+1] = runningMeanFast(moving_avg_y_values[i,:], N)
...
#moving_avg_y_mean[N-1:-N+1] = runningMeanFast (moving_avg_y_mean,N)
